...
public class MasterData {
    ...
    public static Poll getPoll() {
        ...
        poll.setWinner(randomStringWithSize(10));
        poll.setStatus(randomBoolean());
        poll.setVoted(randomBoolean());
        return poll;
    }
    ...
    public static Voter getVoter() {
        ...
        voter.setVoterId(1L);
        voter.setVoterName(randomStringWithSize(10));
        voter.setVoterPassword(randomStringWithSize(10));
        return voter;
    }

    public static List<Voter> getVoterList(int size) {
